# ⚠️ START HERE - MANDATORY WORKFLOW

**YOU MUST READ THIS BEFORE ANY WORK**
...
❌ **WRONG:** "I'll fix the bug in RecipeForm.vue" → Just fixing it directly
✅ **RIGHT:** "As PM, I'm routing this bug fix to Frontend Developer. Frontend Developer will fix RecipeForm.vue."
